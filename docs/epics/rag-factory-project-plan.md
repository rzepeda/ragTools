...
- Pipeline validation: `rag-factory validate-pipeline --indexing chunking,embedding --retrieval reranking`
- Consistency checking: `rag-factory check-consistency` (checks all registered strategies)
...
```bash
# Index documents
rag-factory index --path ./docs --strategies context_aware_chunking,vector_embedding
...
# Check consistency (from Epic 11 Story 11.6)

...
def upgrade() -> None:
    """Create context-aware chunking strategy tables."""
    # Chunks table
    op.create_table(
    ...
    op.create_index(
        'idx_context_aware_vectors_embedding',
        'context_aware_vectors',
        ['vector_embedding'],
...
def downgrade() -> None:
    """Drop context-aware chunking strategy tables."""
    op.drop_table('context_aware_vectors')
    op.drop_table('context_aware_chunks')
    op.drop_table('context_aware_metadata')

...
def upgrade() -> None:
    """Create agentic RAG strategy tables."""
    # Chunks table
    op.create_table(
        'agentic_chunks',
    ...
    op.create_table(
        ...
        sa.Column('chunk_id', sa.String(255), sa.ForeignKey('agentic_chunks.chunk_id')),
...
def downgrade() -> None:
    """Drop agentic RAG strategy tables."""
    op.drop_table('agentic_vectors')
    op.drop_table('agentic_chunks')
    op.drop_table('agentic_metadata')

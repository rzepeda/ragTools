"""Knowledge graph retrieval strategy."""
...
@register_rag_strategy("KnowledgeGraphRetriever")
class KnowledgeGraphRetriever(IRetrievalStrategy):
    ...
    async def retrieve(
        ...
        """Retrieve chunks using knowledge graph and vector search."""

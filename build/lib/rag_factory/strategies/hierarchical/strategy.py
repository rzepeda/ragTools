...
@register_strategy("HierarchicalRAGStrategy")
class HierarchicalRAGStrategy(IRAGStrategy):
    ...
    def __init__(
        ...
        self.vector_store = dependencies.embedding_service if dependencies else None
        self.database = dependencies.database_service if dependencies else None
        ...
        # Only create parent_retriever if we have database service
        if self.database and hasattr(self.database, 'chunk_repository'):
